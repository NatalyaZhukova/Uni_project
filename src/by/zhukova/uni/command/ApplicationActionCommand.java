...
/**
 * The Class ApplicationActionCommand is command which shows registered
 * application to user
 *
...
public class ApplicationActionCommand implements ActionCommand {
	...
	/**
	 * The method gets data of user's own application from database, shows it on
	 * the defined page and allows user to delete it from database.
	 * 
