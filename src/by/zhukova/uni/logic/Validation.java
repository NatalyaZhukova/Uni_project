...
/** 
* The Class Validation contains the methods which check if given object matches the pattern
*
...
public class Validation {
	...
	*/
	...
	/** 
	* The method checks if the given first name, middle name, last name match the patterns
	...
	* @param first, second, third, school
	* @return true, if match
	*/
	...
	*/
	...
	/** 
	* The method checks if the identifiers of given disciplines don't repeat themselves
	* @param disc1 id, disc2 id, disc3 id
